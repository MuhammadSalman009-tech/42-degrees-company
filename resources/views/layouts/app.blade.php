...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="top-nav" id="top-nav">
        ...
        <div class="flags">
            <div class="spain-flag">
                <img src="{{ url('/images/spain-flag.png') }}" alt="spain">
            </div>
            <div class="australia-flag">
                <img src="{{ url('/images/australia-flag.png') }}" alt="autralia">
            </div>
        </div>
    </nav>
    ...
    <div class="offcanvas-header">
        <div class="logo"><img src="{{ url('/images/logo.png') }}" alt="logo"></div>
        <div class="closeNav-btn">
            <img src="{{ url('/images/close-icon.png') }}" alt="close" data-bs-dismiss="offcanvas" aria-label="Close">
        </div>
    </div>
